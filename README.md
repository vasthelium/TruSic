...
This is an EARLY STAGE - EXPERIMENTAL SYSTEM.
Current flow:
	•	User triggers are manually written (moments, thoughts, internal states)
	•	Triggers are stored in a project-level data file (data/music_triggers.md)
...
Mental State Layer:
Beyond explicit triggers, TruSic derives a baseline cognitive state (proxy) from wearable data.
